...
public class ExceptionProcessing implements ErrorController {
    ...
    public ResponseEntity<HTTPResponse> passwordValidException(PasswordValidException exception) {
    ...
    public ResponseEntity<HTTPResponse> emailExistException(EmailExist exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

   @ExceptionHandler(UsernameExist.class)
    public ResponseEntity<HTTPResponse> usernameExistException(UsernameExist exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(EmailNotExist.class)
    public ResponseEntity<HTTPResponse> emailNotFoundException(EmailNotExist exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(UsernameNotExist.class)
    public ResponseEntity<HTTPResponse> userNotFoundException(UsernameNotExist exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
